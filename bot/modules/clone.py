    ...
    if len(args) > 1:
        ...
        if CLONE_LIMIT is not None:
            ...
            if result:
                ...
                return
        if files < 15:
            msg = sendMessage(f"Đang nhân bản: <code>{link}</code>", context.bot, update)
        ...
        sendMessage('Truyền vào một liên kết Google Drive được chia sẻ công khai để nhân bản', context.bot, update)
