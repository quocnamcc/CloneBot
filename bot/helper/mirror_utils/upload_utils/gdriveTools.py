    ...
    def clone(self, link):
        ...
        try:
            ...
            if meta.get("mimeType") == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                msg += f'<b>☞ 📂Tên tệp : </b><code>{file.get("name")}</code>'
                ...
                try:
                    ...
                    typeee = 'File' 
                try:
                    msg += f'\n<b>☞ 📦Kích cỡ : </b><code>{get_readable_file_size(int(meta.get("size")))}</code>'
                    msg += f'\n<b>☞ 🗳Powerd by : 🆅🅼🅴🅽🅿🅽</b> '
                except TypeError:
                    pass
                if INDEX_URL is not None:
    ...
    def count(self, link):
        ...
        try:
            ...
            if drive_file['mimeType'] == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                msg += f'\n<b>☞ 📦Kích cỡ: </b><code>{get_readable_file_size(self.total_bytes)}</code>'
                msg += f'\n<b>☞ 🌀Kiểu : </b><code>Folder</code>'
                msg += f'\n<b>☞ 🗳Powered by : 🆅🅼🅴🅽🅿🅽</b>'
            else:
                msg += f'<b>☞ 📂Tên tệp : </b><code>{name}</code>'
